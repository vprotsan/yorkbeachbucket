...
jQuery(document).on('action.init_hidden_elements', function(e, cont) {
	"use strict";
	if (FOODDY_STORAGE['button_hover'] && FOODDY_STORAGE['button_hover']!='default') {
		jQuery('button:not(.search_submit):not([class*="sc_button_hover_"]),\
				...
				.fooddy_tabs .fooddy_tabs_titles li a:not([class*="sc_button_hover_"]),\
				...
				').addClass('sc_button_hover_just_init sc_button_hover_'+FOODDY_STORAGE['button_hover']);
		if (FOODDY_STORAGE['button_hover']!='arrow') {
		...
		jQuery('.mejs-controls button,\
				...
				').removeClass('sc_button_hover_'+FOODDY_STORAGE['button_hover']);
