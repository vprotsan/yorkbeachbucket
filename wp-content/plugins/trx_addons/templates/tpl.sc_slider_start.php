...
?><div class="<?php echo esc_attr($sc); ?>_slider sc_item_slider	slider_swiper_outer<?php
			echo ' slider_outer_' . esc_attr(trx_addons_is_off($args['slider_controls']) 
				...
				. ' slider_outer_' . esc_attr(trx_addons_is_off($args['slider_pagination']) 
						? 'nopagination'
						: 'pagination slider_outer_pagination_bullets slider_outer_pagination_pos_'.esc_attr($args['slider_pagination']))
	...
	<div class="swiper-slider-container slider_swiper slider_noresize<?php
			echo ' slider_' . esc_attr(trx_addons_is_off($args['slider_controls']) 
				...
				. ' slider_' . esc_attr(trx_addons_is_off($args['slider_pagination']) 
						? 'nopagination'
						: 'pagination slider_pagination_bullets slider_pagination_pos_'.esc_attr($args['slider_pagination']))
