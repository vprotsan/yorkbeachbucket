              ...
              if($thecontent!=""){
                  ...
                  if(isset($imagesarr[$i])&&$imagesarr[$i]!=""){
                    ...
                    if($isresize=="yes"&&$imagewidth!=""){
                        if($imageLocation[0]!="") $image_output .= '<img src="'.aq_resize($imageLocation[0], $imagewidth, $imagewidth, true, true, true).'" class="cq-testimoniallist-image" alt="'.get_post_meta($attachment->ID, '_wp_attachment_image_alt', true ).'">';
                    }else{
                        if($imageLocation[0]!=""){
                          $image_output .= '<img src="'.$imageLocation[0].'" class="cq-testimoniallist-image" alt="'.get_post_meta($attachment->ID, '_wp_attachment_image_alt', true ).'"
      >';
                        }
                    }
                  }else{
