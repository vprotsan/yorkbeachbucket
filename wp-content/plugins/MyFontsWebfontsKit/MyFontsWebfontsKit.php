...
/*
Plugin Name: MyFontsWebfontsKit #3569531
...
add_action( 'admin_init', array('MyFontsInstaller_3569531','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_3569531','mffonts_loadupWebfonts' ));